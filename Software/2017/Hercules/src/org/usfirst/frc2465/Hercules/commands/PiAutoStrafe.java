 ...
 *
 */
public class PiAutoStrafe extends Command {
    ...
    public PiAutoStrafe(float desired_angle, double timeout) {
    ...
    protected void initialize() {
    	float pi_X = Robot.vision.getCurrentX();
    	pi_travel = (float) ((-pi_X) - 10.5);
    	
    	
    	fod_enabled = Robot.drive.getFODEnabled();
    	Robot.drive.setFODEnabled(false);
    	Robot.drive.enableAutoStrafe(pi_travel);
