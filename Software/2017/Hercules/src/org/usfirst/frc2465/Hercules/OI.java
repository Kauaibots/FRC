...
public class OI {
    ...
    public JoystickButton tiltUpFunnelButton;
    public JoystickButton tiltUpPinchersButton;
    public JoystickButton closePinchersButton;
    public JoystickButton openPinchersButton;
    ...
    public OI() {
        ...
        tiltUpPinchersButton = new JoystickButton(driver, 3);
        tiltUpPinchersButton.whileHeld(new TiltPincherU());
        
        closePinchersButton = new JoystickButton(driver, 4);
        closePinchersButton.whileHeld(new ClosePincher());
        
        openPinchersButton = new JoystickButton(driver, 5);
        openPinchersButton.whileHeld(new OpenPincher());
        ...
        SmartDashboard.putData("TiltFunnelU", new TiltFunnelU());
        SmartDashboard.putData("TiltFunnelD", new TiltFunnelD());
