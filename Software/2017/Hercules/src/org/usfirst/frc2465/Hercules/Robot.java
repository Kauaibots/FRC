...
public class Robot extends IterativeRobot implements PIDOutput {
    ...
    static final double kToleranceInches = 0.125f;
    ...
    RobotMap.init();
        ...
        strafeController = new PIDController(kP, kI, kD, kF, ahrs, this);
        strafeController.setInputRange(-180.0f,  180.0f);
        strafeController.setOutputRange(-1.0, 1.0);
        strafeController.setAbsoluteTolerance(kToleranceInches);
