...
import org.usfirst.frc2465.Hercules.RobotPreferences;
...
public class Drive extends PIDSubsystem implements PIDSource, PIDOutput {
    ...
    PIDController strafe_controller;
    
    boolean isAutoStrafeEnabled = false;
    double next_strafe_value = 0.0;
    PIDSourceType strafe_pid_source_type;

    
    static final int AUTO_STRAFE_ERROR_HISTORY_LENGTH = 5;
    double auto_strafe_error_history[];
    int auto_strafe_error_history_index;
...
//////////////////////////////////////////////////////////
    ...
    double strafe_tolerance_inches;
    ...
    public Drive() {
        ...
        initAutoRotateHistory();
        
        
        //STRAFE ERROR
        strafe_controller = new PIDController(sP, sI, sD, sFF, this, this);
        strafe_controller.setOutputRange(-1, 1);
        strafe_controller.setInputRange(-100000, 100000);
        strafe_controller.setContinuous(false);
        strafe_controller.setAbsoluteTolerance(1.0);
        strafe_controller.setSetpoint(0);
        strafe_controller.disable();
        
        auto_strafe_error_history = new double[AUTO_STRAFE_ERROR_HISTORY_LENGTH];   
        ...
        try {
            ...
            strafe_tolerance_inches = 1.0; /* TODO:  Tune this variable. */
    ...
    public void initAutoRotateHistory() {
        for ( int i = 0; i < AUTO_ROTATE_ERROR_HISTORY_LENGTH; i++) {
        	auto_rotate_error_history[i] = Double.MAX_VALUE;
        }
  ...
  ///////////////////////////////////////////////////////////////////////////
    ...
    public void enableAutoStrafe(double distance_in_inches){
    	initAutoStrafeHistory();
    	RobotMap.strafeEncoder.reset();
    	strafe_controller.setSetpoint(distance_in_inches);
    	isAutoStrafeEnabled = true;
    	strafe_controller.enable();
    }
    
    public void disableAutoStrafe(){
    	isAutoStrafeEnabled = false;
    	strafe_controller.disable();
    }
    
    public void initAutoStrafeHistory() {
        for ( int i = 0; i < AUTO_STRAFE_ERROR_HISTORY_LENGTH; i++) {
        	auto_strafe_error_history[i] = Double.MAX_VALUE;
        }
        auto_strafe_error_history_index = 0;
    }
    
    public boolean isAutoStrafeOnTarget() {
    	boolean on_target;
    	double average_error = 0;
    	for ( int i = 0; i < AUTO_STRAFE_ERROR_HISTORY_LENGTH; i++) {
    		average_error += this.auto_strafe_error_history[i];
    	}
    	average_error = average_error / AUTO_STRAFE_ERROR_HISTORY_LENGTH;
    ...
    {
    	strafe_controller.setPID( sP, sI, sD, sFF);
    }
    ...
    public void doMecanum( double vX, double vY, double vRot) {
        ...
        if ( isAutoStrafeEnabled ) {
            vX = next_strafe_value;
        }
...
//        vY = Math.sin(theta  curr_gyro_angle_radians) * distance;
	...
	public double pidGet() {
		return getStrafeDistanceInches();
	}
