...
public class Drive extends PIDSubsystem {
    ...
    static final int STRAFE_ERROR_HISTORY_LENGTH = 5;
    double strafe_error_history[];
    int strafe_error_history_index;
...
//////////////////////////////////////////////////////////
    ...
    public Drive() {
        ...
        //STRAFE ERROR
        strafe_error_history = new double[STRAFE_ERROR_HISTORY_LENGTH];
        for ( int i = 0; i < STRAFE_ERROR_HISTORY_LENGTH; i++) {
        	strafe_error_history[i] = 0;
        }
        strafe_error_history_index = 0;
