...
public class _Side extends CommandGroup {
	...
	public void initialize() {
		System.out.println("New Run Side\n");
		...
		System.out.println("Scale" + String.valueOf(scalePos) + "Switch " + String.valueOf(switchPos) + "    "
				+ RobotPreferences.startingPosition);
	}
