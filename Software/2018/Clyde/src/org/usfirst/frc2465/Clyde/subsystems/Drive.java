...
public class Drive extends PIDSubsystem {
	...
	public Drive() {
		...
		SmartDashboard.putNumber("RotateP", 0.0025);
		SmartDashboard.putNumber("RotateI", 0.0);
		SmartDashboard.putNumber("RotateD", 0.0);
	...
	public void updatePID() {
		getPIDController().setPID(SmartDashboard.getNumber("RotateP", 0.0025), SmartDashboard.getNumber("RotateI", 0.0),
				SmartDashboard.getNumber("RotateD", 0.0));
	}
