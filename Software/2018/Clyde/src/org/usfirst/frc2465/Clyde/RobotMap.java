...
public class RobotMap {
	...
	public static void init() {
       ...
       // LiveWindow.addActuator("Drive", "LeftGearShift", leftGearShift);
        ...
        elevatorMotor = new PWMTalonSRX(1);
        LiveWindow.addActuator("Elevator", "ElevatorMotor", (PWMTalonSRX) elevatorMotor);
        elevatorMotor.setInverted(false);
        //clawLifter = new DoubleSolenoid(5, 0, 1);
        //LiveWindow.addActuator("Claw", "ClawLifter", clawLifter);
        
        clawMotor = new PWMTalonSRX(2);
        LiveWindow.addActuator("Claw", "ClawMotor", (PWMTalonSRX) clawMotor);
