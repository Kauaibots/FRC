...
public class RobotMap {
	...
	public static void init() {
       ...
       // LiveWindow.addActuator("Drive", "LeftGearShift", leftGearShift);
        ...
        elevatorMotor = new PWMVictorSPX(1);
        LiveWindow.addActuator("Elevator", "ElevatorMotor", (PWMVictorSPX) elevatorMotor);
        elevatorMotor.setInverted(false);
        //clawLifter = new DoubleSolenoid(5, 0, 1);
        //LiveWindow.addActuator("Claw", "ClawLifter", clawLifter);
        
        clawMotor = new PWMVictorSPX(2);
        LiveWindow.addActuator("Claw", "ClawMotor", (PWMVictorSPX) clawMotor);
