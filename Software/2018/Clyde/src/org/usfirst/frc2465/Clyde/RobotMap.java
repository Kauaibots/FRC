...
public class RobotMap {
    ...
    public static WPI_TalonSRX clawMotor1;
    public static WPI_TalonSRX clawMotor2;
	...
	public static void init() {
       ...
       // LiveWindow.addActuator("Drive", "LeftGearShift", leftGearShift);
        ...
        LiveWindow.addActuator("Elevator", "ElevatorMotor", (WPI_TalonSRX) elevatorMotor);
        elevatorMotor.setInverted(false);
        //clawLifter = new DoubleSolenoid(5, 0, 1);
        //LiveWindow.addActuator("Claw", "ClawLifter", clawLifter);
        
        clawMotor1 = new WPI_TalonSRX(6);
        clawMotor2 = new WPI_TalonSRX(7);
        clawMotors = new SpeedControllerGroup(clawMotor1, clawMotor2);
        LiveWindow.addActuator("Claw", "ClawMotor", (WPI_TalonSRX) clawMotor1);
