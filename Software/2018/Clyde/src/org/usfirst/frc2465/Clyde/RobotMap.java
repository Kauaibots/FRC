...
public class RobotMap {
	...
	public static void init() {
        ...
        SpeedControllerGroup m_left = new SpeedControllerGroup(driveTalonSRX1, driveTalonSRX2);
        m_left.setInverted(true);
        
        
        driveTalonSRX3 = new WPI_TalonSRX(3);
        driveTalonSRX4 = new WPI_TalonSRX(4);
        SpeedControllerGroup m_right = new SpeedControllerGroup(driveTalonSRX3, driveTalonSRX4);
        m_right.setInverted(false);
        
        
        driveRobotDrive41 = new DifferentialDrive(m_left, m_right);
