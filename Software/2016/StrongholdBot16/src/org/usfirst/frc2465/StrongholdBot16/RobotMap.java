...
public class RobotMap {
    ...
    public static DigitalInput ballGrabLimit;
    ...
    public static void init() {
        ...
        lidar = new LidarLITE(Port.kOnboard);
        LiveWindow.addSensor("LIDAR", "Lidar", lidar);
        
        ballGrabSpeedController = new VictorSP(7);
        LiveWindow.addActuator("BallGrab", "SpeedController", ballGrabSpeedController);
        
        ballGrabLimit = new DigitalInput(9);
        LiveWindow.addSensor("BallGrab", "Limit", ballGrabLimit);
