...
public class OI {
    ...
    public OI() {
	    ...
	    wedgePort = new InternalButton();
	    wedgePort.whileHeld(new DoWedge(true));
	    ballGrabber = new InternalButton();
	    ballGrabber.whileHeld(new BallGrab());
